...
namespace FrontBlazor.Components.Models
{
    public class Panel
    {
        ...
        [Range(0, 10000, ErrorMessage = "El largo del panel debe tener un valor positivo en milímetros")]
        public int Largo { get; set; }
        [Required(ErrorMessage = "Es necesario introducir las dimensiones del panel")]
        [Range(0, 10000, ErrorMessage = "El ancho del panel debe tener un valor positivo en milímetros")]
        public int Ancho { get; set; }
        [Required(ErrorMessage = "Es necesario introducir la potencia pico del panel")]
        [Range(0, 10000, ErrorMessage = "La potencia debe tener un valor positivo")]
        public int Potencia { get; set; }
        [Required(ErrorMessage = "Es necesario introducir el voltaje")]
        [Range(0, 10000, ErrorMessage = "El voltaje debe ser positivo")]
